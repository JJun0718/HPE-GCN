...
plot_Matrix(y_true, svm_y_pred, classes, 'Result/svm_y_pred_confusion_matrix.png')
plot_Matrix(y_true, nb_y_pred, classes, 'Result/nb_y_pred_confusion_matrix.png')
plot_Matrix(y_true, lr_y_pred, classes, 'Result/lr_confusion_matrix.png')
plot_Matrix(y_true, gbdt_y_pred, classes, 'Result/gbdt_confusion_matrix.png')
plot_Matrix(y_true, knn_y_pred, classes, 'Result/knn_confusion_matrix.png')
plot_Matrix(y_true, gcn_y_pred, classes, 'Result/HPE_GCN_confusion_matrix.png')